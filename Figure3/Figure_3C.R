...
fin_scaled_count_tmp <- source_data_fig_3C %>% dplyr::group_by(variable, skewed) %>% dplyr::count()
...
plot_grid(rel_widths = c(0.9,0,1), ncol = 2,
          ggdensity(source_data_fig_3C, x="skewing", col = "variable", add = "median") + 
