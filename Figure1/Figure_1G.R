...
ARHGAP6_PCR_prod <- data.frame(start = 11427654, stop = 11427890)
CNKSR2_PCR_prod <- data.frame(start = c(21374408), stop = c(21374708))
RP2_PCR_prod <- data.frame(start = c(46836203), stop = c(46836692))
TCAC1_PCR_prod <- data.frame(start = c(137545307), stop = c(137545689))
ZIC3_PCR_prod <- data.frame(start = c(137568039), stop = c(137568606))
AR_PCR_prod_NOT_CORRECT <- data.frame(start = c(67545231), stop = c(67545443))
...
unique(ARHGAP6_meth$pos)
unique(CNKSR2_meth$pos)
unique(RP2_meth$pos)
unique(TCAC1_meth$pos)
unique(ZIC3_meth$pos)
